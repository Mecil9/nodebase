 ...
 * @LastEditTime: 2025-11-12 16:04:55
 * @FilePath: /nodebase/src/components/features/triggers/components/google-form-trigger/dialog.tsx
 * @Description: 手动触发弹窗
 *
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
              ...
              <li>Replace WEBHOOK_URL with the URL above</li>
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <li>
                ...
                - All responses as a JSON object
              </li>
            </ul>
          </div>
        </div>
