 ...
 * @LastEditTime: 2025-11-24 21:43:40
 * @FilePath: /nodebase/src/components/features/executions/components/openai/dialog.tsx
 * @Description: 手动触发弹窗
 *
...
export const OpenAiDialog = ({
  ...
  const watchVariableName = form.watch("variableName") || "myOpenAi Call";
