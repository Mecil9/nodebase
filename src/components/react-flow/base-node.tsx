/*
 * @Author: Mecil Meng
 * @Date: 2025-11-07 17:33:23
 * @LastEditors: Mecil Meng
 * @LastEditTime: 2025-11-08 22:24:32
 * @FilePath: /nodebase/src/components/react-flow/base-node.tsx
 * @Description:
 *
...
import { CheckCircleIcon, Loader2Icon, XCircle } from "lucide-react";
...
export const BaseNode = forwardRef<HTMLDivElement, BaseNodeProps>(
  ({ className, status, ...props }, ref) => (
    ...
    >
      ...
      {status === "loading" && (
        <Loader2Icon className="absolute -right-0.5 -bottom-0.5 size-2 text-primary stroke-3 animate-spin" />
      )}
    </div>
  )
);
